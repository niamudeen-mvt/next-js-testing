...
const CartPage = () => {
  ...
  return (
    <section>
      <div
        className={`w-[75%] min-h-[80vh] mx-auto flex flex-col gap-y-8 py-10 ${
          cartProducts?.length ? "" : "justify-center items-center"
        } `}
      >
        {cartProducts?.length ? (
          <>
          ...
          <div className="flex items-center flex-col gap-y-4">
            ...
            <Link href="/">
              <button className="common__btn">Go to Shopping</button>
            </Link>
          </div>
        )}
      </div>
